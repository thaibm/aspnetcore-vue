...
{
    public abstract class VUEWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static VUEWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(VUEWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<VUEDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<VUEDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<VUEDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<VUEDbContext, Task<T>> func)
        {
            T result;
